...
// get current category in archive page
				...
				<div class="default-banner__images a-up a-delay-1">
					<?php foreach ( $categories as $category ) : ?>
						<div class="default-banner__image">
							<a href="<?php echo esc_url( get_category_link( $category ) ); ?>" class="default-banner__link<?php echo $current_category == $category ? ' is-active' : ''; ?>">
