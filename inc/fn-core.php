...
function am_add_javascript() {
	...
	if ( ! is_admin() ) {
		...
		if ( is_page_template( 'page-templates/explore.php' ) ) {
			$am_links[] = 'https://api.mapbox.com/mapbox-gl-js/v2.14.1/mapbox-gl.js';
			$am_links[] = 'https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-directions/v4.1.1/mapbox-gl-directions.js';
		}
...
function am_add_css() {
	...
	if ( is_page_template( 'page-templates/explore.php' ) ) {
		$am_links[] = 'https://api.mapbox.com/mapbox-gl-js/v2.14.1/mapbox-gl.css';
		$am_links[] = 'https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-directions/v4.1.1/mapbox-gl-directions.css';
	}
	foreach ( $am_links as $am_link ) {
