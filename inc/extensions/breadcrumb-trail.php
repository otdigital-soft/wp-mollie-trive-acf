...
function breadcrumb_trail( $args = array() ) {
	...
	if ( is_home() && ! is_front_page() ) {
		...
		if ( is_page() ) {
			...
			if ( is_singular( 'room' ) ) {
				$trail[] = '<a href="' . home_url( '/rooms/' ) . '" class="link-back" title="' . esc_attr__( 'Rest', 'am' ) . '">' . __( 'Rest', 'am' ) . '</a>';
			}
			if ( is_singular( 'dining' ) ) {
				$trail[] = '<a href="' . home_url( '/restaurants-bars/' ) . '" title="' . esc_attr__( 'Taste', 'am' ) . '">' . __( 'Taste', 'am' ) . '</a>';
			}
		}
		...
		if ( is_tax() || is_category() || is_tag() ) {
			...
			if ( is_category() ) {
				$trail[] = '<a href="' . home_url( '/blog/' ) . '" title="' . esc_attr__( 'Blog', 'am' ) . '">' . __( 'Blog', 'am' ) . '</a>';
			}
