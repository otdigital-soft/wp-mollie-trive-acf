...
if ( function_exists( 'acf_add_options_page' ) ) {
	...
	acf_add_options_page(
		array(
			'page_title' => 'Mollie Settings',
			'menu_title' => 'Mollie Settings',
			'menu_slug'  => 'mollie-settings',
...
// Image Sizes
add_image_size( 'full-content-image', 690, 985, true );
add_image_size( 'full-content-image-2x', 1380, 1970, true );
add_image_size( 'loop-event', 690, 490, true );
add_image_size( 'loop-room', 1360, 760, true );
add_image_size( 'loop-location', 220, 220, true );
